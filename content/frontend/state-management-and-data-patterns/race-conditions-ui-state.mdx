...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/state-management-and-data-patterns/race-conditions-ui-state.m4a"
  title="Race Conditions in UI State"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/state-management-and-data-patterns/race-conditions-ui-state.png"
  alt="Race Conditions in UI State overview"
/>
