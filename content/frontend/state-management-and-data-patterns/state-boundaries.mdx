...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/state-management-and-data-patterns/state-boundaries.m4a"
  title="State Boundaries"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/state-management-and-data-patterns/state-boundaries.png"
  alt="State Boundaries overview"
/>
