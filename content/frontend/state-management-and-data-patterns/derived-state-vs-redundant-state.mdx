...
description: How to identify and eliminate redundant state — values that can be computed from existing state — and the tools React, Zustand, and Jotai provide to express derivation correctly.
---

<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/state-management-and-data-patterns/derived-state-vs-redundant-state.m4a"
  title="Derived vs Redundant State"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/state-management-and-data-patterns/derived-state-vs-redundant-state.png"
  alt="Derived vs Redundant State overview"
/>
