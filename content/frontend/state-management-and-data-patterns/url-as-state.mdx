...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/state-management-and-data-patterns/url-as-state.m4a"
  title="URL as State"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/state-management-and-data-patterns/url-as-state.png"
  alt="URL as State overview"
/>
