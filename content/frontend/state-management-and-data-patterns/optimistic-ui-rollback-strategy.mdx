...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/state-management-and-data-patterns/optimistic-ui-rollback-strategy.m4a"
  title="Optimistic UI & Rollback"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/state-management-and-data-patterns/optimistic-ui-rollback-strategy.png"
  alt="Optimistic UI & Rollback overview"
/>
