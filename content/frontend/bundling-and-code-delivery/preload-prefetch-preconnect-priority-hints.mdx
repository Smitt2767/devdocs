...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/bundling-and-code-delivery/preload-prefetch-preconnect-priority-hints.m4a"
  title="Preload, Prefetch & Priority Hints"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/bundling-and-code-delivery/preload-prefetch-preconnect-priority-hints.png"
  alt="Preload, Prefetch & Priority Hints overview"
/>
