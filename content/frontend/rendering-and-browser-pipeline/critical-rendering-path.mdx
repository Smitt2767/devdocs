...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/rendering-and-browser-pipeline/critical-rendering-path.m4a"
  title="Critical Rendering Path"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/rendering-and-browser-pipeline/critical-rendering-path.png"
  alt="Critical Rendering Path overview"
/>
