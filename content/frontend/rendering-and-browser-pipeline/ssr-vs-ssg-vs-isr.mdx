...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/rendering-and-browser-pipeline/ssr-vs-ssg-vs-isr.m4a"
  title="SSR vs SSG vs ISR"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/rendering-and-browser-pipeline/ssr-vs-ssg-vs-isr.png"
  alt="SSR vs SSG vs ISR overview"
/>
