...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/rendering-and-browser-pipeline/paint-vs-composite-vs-layout.m4a"
  title="Paint vs Layout vs Composite"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/rendering-and-browser-pipeline/paint-vs-composite-vs-layout.png"
  alt="Paint vs Layout vs Composite overview"
/>
