...
<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/rendering-and-browser-pipeline/browser-compositing-layers.png"
  alt="Browser Compositing Layers overview"
/>
