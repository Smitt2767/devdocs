...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/rendering-and-browser-pipeline/react-server-components-rendering-model.m4a"
  title="RSC Rendering Model"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/rendering-and-browser-pipeline/react-server-components-rendering-model.png"
  alt="RSC Rendering Model overview"
/>
