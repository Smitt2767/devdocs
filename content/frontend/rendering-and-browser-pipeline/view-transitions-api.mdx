...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/rendering-and-browser-pipeline/view-transitions-api.m4a"
  title="View Transitions API"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/rendering-and-browser-pipeline/view-transitions-api.png"
  alt="View Transitions API overview"
/>
