...
description: A practical comparison of REST, GraphQL, and tRPC — N+1 prevention with DataLoader, persisted queries, OpenAPI spec generation with zod-openapi, tRPC subscriptions, REST versioning strategies, and a decision framework for choosing the right paradigm.
---

<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/networking-and-protocols/api-paradigms.m4a"
  title="API Paradigms"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/networking-and-protocols/api-paradigms.png"
  alt="API Paradigms overview"
/>
...
<Callout type="warn">
  tRPC subscriptions require WebSocket or SSE transport — not supported in
...
| Flexible client queries         | ❌        | ✅        | Limited |
