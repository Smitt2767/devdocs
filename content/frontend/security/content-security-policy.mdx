...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/security/content-security-policy.m4a"
  title="Content Security Policy"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/security/content-security-policy.png"
  alt="Content Security Policy overview"
/>
