...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/security/csrf-vs-xss-mitigation.m4a"
  title="CSRF vs XSS Mitigation"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/security/csrf-vs-xss-mitigation.png"
  alt="CSRF vs XSS Mitigation overview"
/>
