...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/caching-and-storage/service-worker-lifecycle-traps.m4a"
  title="Service Worker Lifecycle Traps"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/caching-and-storage/service-worker-lifecycle-traps.png"
  alt="Service Worker Lifecycle Traps overview"
/>
