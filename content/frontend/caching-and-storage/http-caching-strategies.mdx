...
<Audio
  src="https://frontcore.t3.storage.dev/audios/frontend/caching-and-storage/http-caching-strategies.m4a"
  title="HTTP Caching Strategies"
/>

<Img
  src="https://frontcore.t3.storage.dev/Images/frontend/caching-and-storage/http-caching-strategies.png"
  alt="HTTP Caching Strategies overview"
/>
