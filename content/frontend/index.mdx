...
Topics include: hydration, partial and selective hydration, streaming SSR, concurrent rendering, React's fiber architecture and reconciliation algorithm, the critical rendering path, render-blocking resources, browser compositing layers, paint vs composite vs layout, and render waterfalls.
...
Topics include: Interaction to Next Paint, Cumulative Layout Shift, Largest Contentful Paint, Lighthouse CI integration, RUM vs synthetic monitoring, and performance budgets.
