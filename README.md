...
**Content:** All documentation (MDX articles) in this project was created with [Claude](https://www.anthropic.com/claude) (Anthropic AI). Audio overviews for every topic were generated with [NotebookLM](https://notebooklm.google.com/) (Google). The handbook is maintained as a personal reference and is openly shared.
...
Every topic in the handbook has a companion audio overview available at [`/podcasts`](https://frontcore.vercel.app/podcasts). Episodes are organized by category and playable as a continuous playlist via a persistent sticky player that follows you across all pages.
...
| `src/app/(public)/page.tsx`      | Landing page (category list + counts)                     |
| `src/app/(public)/podcasts/`     | Podcast playlist page                                     |
...
- [Claude](https://www.anthropic.com/claude) (Anthropic) — all written content and MDX articles
- [NotebookLM](https://notebooklm.google.com/) (Google) — audio overviews for every topic
